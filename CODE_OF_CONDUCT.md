...
The maintainer is responsible for clarifying and enforcing our standards of acceptable behaviour and will take appropriate and fair corrective action in response to any behaviour that is deemed inappropriate, threatening, offensive, or harmful.
...
This Code of Conduct applies within all community spaces — GitHub Issues, Pull Requests, Discussions, and any other forum used by this project — and also applies when an individual is officially representing the community in public spaces.
...
**1. Correction** — A private, written warning with clarity around the nature of the violation and an explanation of why the behaviour was inappropriate.
