...
TP_CASES: list[tuple[str, str, list[str]]] = [
    ...
    ("gcp_api_key",          "app.js",            ['const GCP_KEY = "AIzaABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghi"']),
    ...
    ("github_pat_classic",   "deploy.sh",         ['GITHUB_TOKEN="ghp_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghij"']),
    ("github_fine_grained",  "ci.env",            ['GH_TOKEN="github_pat_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRST"']),
    ("github_actions_token", "workflow.yml",      ['token: ghs_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghij']),
    ("slack_bot_token",      "notify.py",         ['SLACK_TOKEN = "xoxb-123456789012-123456789012-ABCDEFabcdefABCDEFabcdef"']),
    ("sendgrid_key",         "mailer.py",         ['SG_KEY = "SG.ABCDEFGHIJKLMNOPQRSTUV.YZabcdefghijklmnopqrstuvwxyz0123456789ABCDE"']),
